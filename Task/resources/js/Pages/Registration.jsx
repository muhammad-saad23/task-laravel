  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-6 font-sans">
      <div className="w-full bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-700">
        <h1 className="text-3xl font-bold text-white text-center my-2">Create Account</h1>
        <p className="text-center text-gray-400 mb-8">
          Sign up to get started with your Inertia app.
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col p-5 mt-8 space-y-6">
          <TextInput name="name" value={data.name} onChange={(e)=>setData('name',e.target.value)} type="text"  placeholder="Your Full Name" />
          <InputError name="name" message={errors.name} />
          ...
          <TextInput name="phone" value={data.phone} onChange={(e)=>setData('phone',e.target.value)} type="text"  placeholder="Your Phone Number" />
          <InputError name="phone" message={errors.phone} />
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <a href={route('user.login.get')} className="text-blue-500 hover:text-blue-400 font-medium ml-1">
            Log in here
          </a>
        </p>
      </div>
